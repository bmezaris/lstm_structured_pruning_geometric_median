...
from utils import average_precision_calculator as ap_calculator, mean_average_precision_calculator as map_calculator
import numpy
...
class EvaluationMetrics(object):
  ...
  def report(self):
    ...
    aps = self.map_calculator.peek_map_at_n() # for each class
    gap = self.global_ap_calculator.peek_ap_at_n()
